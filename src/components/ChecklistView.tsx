...
export default function ChecklistView() {
  const [completedItems, setCompletedItems] = useState<string[]>(() => {
    ...
    // Default some items to give user an idea
    return ["prod-login", "prod-cadastro", "prod-dados-separados", "seg-senhas", "seg-rotas", "seg-dados-isolados", "seg-variaveis-fora-frontend", "com-nome-metria", "com-textos", "mob-login", "tst-fazer-login"];
  });
